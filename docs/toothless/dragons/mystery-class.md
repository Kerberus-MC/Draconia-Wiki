...
<sub>Content adapted from the [Archipelago Additions Wiki](https://archipelagoadditions.miraheze.org/wiki/Mystery_Class) under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).</sub>
